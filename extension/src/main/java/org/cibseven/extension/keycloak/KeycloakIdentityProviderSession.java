package org.cibseven.extension.keycloak;

import static org.cibseven.extension.keycloak.json.JsonUtil.*;
...
import org.cibseven.extension.keycloak.cache.QueryCache;
import org.cibseven.extension.keycloak.json.JsonException;
import org.cibseven.extension.keycloak.rest.KeycloakRestTemplate;
import org.cibseven.extension.keycloak.util.ContentType;
import org.cibseven.extension.keycloak.util.KeycloakPluginLogger;
...
public class KeycloakIdentityProviderSession implements ReadOnlyIdentityProvider {
	 ...
	 * 
	 * @see org.cibseven.bpm.extension.keycloak.KeycloakUserService#getKeycloakAdminUserId(java.lang.String)
	 */
	 ...
	 * 
	 * @see org.cibseven.bpm.extension.keycloak.KeycloakGroupService#getKeycloakAdminGroupId(java.lang.String)
	 */
