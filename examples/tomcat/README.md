...
This document describes the installation of the **Keycloak CIB seven Identity Provider Plugin** on a full distribution for Apache Tomcat.

## CIB seven Installation on Apache Tomcat

For information on how to install CIB seven on Apache Tomcat carefully read and follow the installation reference within the CIB seven Docs.
...
...
    ...
    <plugins>
        ...
        <plugin>
        <class>org.cibseven.extension.keycloak.plugin.KeycloakIdentityProviderPlugin</class>
        <properties>
            <property name="keycloakIssuerUrl">https://somehost:8443/auth/realms/cibseven</property>
            <property name="keycloakAdminUrl">https://somehost:8443/auth/admin/realms/cibseven</property>
            <property name="clientId">cibseven-identity-service</property>
            ...
            <property name="administratorGroupName">cibseven-admin</property>
