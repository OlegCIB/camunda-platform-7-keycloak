package org.cibseven.extension.keycloak.filter;

import org.cibseven.bmp.cockpit.Cockpit;
import org.cibseven.bmp.cockpit.impl.DefaultCockpitRuntimeDelegate;
import org.cibseven.bmp.engine.IdentityService;
import org.cibseven.bmp.engine.impl.identity.Authentication;
import org.cibseven.bmp.engine.impl.test.PluggableProcessEngineTestCase;
import org.cibseven.bmp.engine.rest.security.auth.AuthenticationProvider;
import org.cibseven.bmp.engine.rest.security.auth.AuthenticationResult;
import org.cibseven.extension.keycloak.auth.KeycloakJwtAuthenticationFilter;
